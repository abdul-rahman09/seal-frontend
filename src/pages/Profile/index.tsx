...
const Profile: FunctionComponent<IProfile> = ({ updateProfile }) => {
  ...
  const handleSubmit = (values: any, { setErrors }: any) => {
    ...
    updateProfile(username, password, firstName, lastName)
      .then((resp: any) => {
      ...
      .catch((error: any) => {
        ...
        const { firstName, lastName, username, password } = error;
        setErrors({ firstName, lastName, username, password });
      });
  };
  return (
...
const mapDispatchToProps = (dispatch: any) => {
  return {
    updateProfile: (
      ...
      firstName: string,
      lastName: string
    ) => dispatch(updateProfileAction(username, password, firstName, lastName)),
  };
};
